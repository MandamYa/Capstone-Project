...
// --- AKHIR VARIABEL KHUSUS MODIFIKASI ---
...
function updateToggleState(theme) {
    ...
    // LOGIKA TOOLTIP TEMA
    const toggleLabel = domElements.toggleSwitchLabel;
    
    if (toggleLabel) {
        // [TERJEMAHAN] Tooltip tema
        const newTooltipText = (theme === 'dark') 
            ? getTranslation('tooltip_theme_light') 
            : getTranslation('tooltip_theme_dark'); 

        toggleLabel.setAttribute('data-tooltip', newTooltipText);
    }
}
